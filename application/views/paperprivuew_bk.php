                        ...
                        <tbody>
                          ...
                          if (isset($PaperPreview_data['data']) && is_array($PaperPreview_data['data']) && count($PaperPreview_data['data']) > 0) {
                            foreach ($PaperPreview_data['data'] as $abc_PaperPreview_data) { ?>
                              <tr class="record_<?= $abc_PaperPreview_data['Id']; ?>">
                                <td><?= $abc_PaperPreview_data['FormatNumber']; ?></td>
                                <td><?= $abc_PaperPreview_data['SubjectName']; ?></td>
                                <td><?= $abc_PaperPreview_data['Course']; ?></td>
                                <td><?= $abc_PaperPreview_data['Session']; ?></td>
                                <td><?= $abc_PaperPreview_data['Semester']; ?></td>
                                <td>
                                  <?php if ($abc_PaperPreview_data["Status"] == 1) { ?>
                                    <div><small class="btn btn-pill btn-light-gradien txt-dark"><b>Active</b></small></div>
                                  <?php } else { ?>
                                    <div><small class="btn btn-pill btn-danger"><b>Inactive</b></small></div>
                                  <?php } ?>
                                </td>
                                <td>
                  ...
                  <?php } elseif ($pgAct == "viewdata") { ?>
                    <div class="table-responsive">
                      <div class="paper-wrap" role="document" aria-label="Exam paper view">
                        ...
                        <?php   //echo "error==><pre>";print_r($PaperPreview_data['data']);
                        if (isset($PaperPreview_data['data']) && is_array($PaperPreview_data['data']) && count($PaperPreview_data['data']) > 0) {
                          foreach ($PaperPreview_data['data'] as $abc_PaperPreview_data) { ?>
                            ...
                            <table border="1" width="100%">
                              <tbody>
                                <tr>
                                  <td colspan="3" style="text-align:center"><b>(June–2025)</b> Non-Technical Programs : New Question Paper Format</td>
                                </tr>
                                <tr>
                                  <td colspan="3" style="text-align:center"><b>END TERM EXAMINATION</b></td>
                                </tr>
                                <tr>
                                  <td><b>Program:</b> <?= $abc_PaperPreview_data['SubjectName'] ?></td>
                                  <td><b>Branch:</b> <?= $abc_PaperPreview_data['Course'] ?></td>
                                  <td><b>Semester:</b> <?= $abc_PaperPreview_data['Semester'] ?></td>
                                </tr>
                                <tr><td colspan="3"><b>Course Code:</b></td></tr>
                                <tr><td colspan="3"><b>Course Name (Full Name):</b></td></tr>
                                <tr>
                                  <td><b>Max. Marks: <?= $abc_PaperPreview_data['FormatData'][1]['TotalMarks'] ?></b></td>
                                  <td></td>
                                  <td><b>Min. Marks: <?= $abc_PaperPreview_data['FormatData'][1]['MinMarks'] ?></b></td>
                                </tr>
                              </tbody>
                            </table>
                            <hr />
